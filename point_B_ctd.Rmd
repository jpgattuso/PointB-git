...
=======
  paste0(path,"data/radehydro_ctd/", "radehydro_ctd_20190906.csv"),
  delim = ",",
  col_names = TRUE,
  col_types = cols(fluo_calib = "d", fluorescence="d", oxygen_mll="d", oxygen_sat="d", oxygen_umolkg="d", par="d", v0="d", v2="d"),
>>>>>>> 6fed25a4a23220a43b6d09a486b1c7133c325aa7
  na = c("NA")
) %>%
...
plot_min-max <- temp_yr %>%
  ...
  geom_linerange(aes(ymin = max(temp_yr, na.rm = TRUE), 
                 ymax = min(temp_yr, na.rm = TRUE)))
