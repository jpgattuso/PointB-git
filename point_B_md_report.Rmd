...
ggsave(file = paste0(path,"/figures/fig_ta_vs_salinity_0m.png"), p1,
...
dyf_surf_salinity_AT <- ggplot(data = dyf_surf, aes(x=salinity, y=AT), na.rm=TRUE) +
  ...
  stat_smooth(method = lm, na.rm=TRUE)
ggsave(file = paste0(path,"/figures/dyf_surf_salinity_AT.png"), dyf_surf_salinity_AT,
...
ggsave(file = paste0(path,"figures/dyf_surf_salinity_AT_year.png"), dyf_surf_salinity_AT_year,
...
![dyf_surf_salinity_AT_year](../../pCloud Sync/exp153_carbonates_point_B/figures/dyf_surf_salinity_AT_year.png)
...
# read data and create a data frame tbl
# z <- read_excel(path = "../data/Data_DIC_2017-06-20.xls",
#                   skip=1, sheet = "Data_DIC_2017-06-19",
...
# Exclude data for 2017 and later
z <- filter(z, sampling_date < "2018-01-01")
...
#cowplot::
ggsave(file=paste0(path,"/figures/fig4.pdf"), g,  width = 8, height = 28, units = "cm")
g <- plot_grid(T1vp, S1vp, AT1vp, CT1vp, pH1vp, pCO21vp, Oa1vp, ncol=2)
ggsave(file=paste0(path,"/figures/fig_paper_monthly_means_1m.png"), g, width = 18, height = 14, units = "cm")
...
![monthly_means_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_paper_monthly_means_1m.png)
...
ATvsCT1p <- ggplot(mean0m, aes(x = sampling_date, y = mean_ta/mean_dic), na.rm=TRUE) +
  ...
  coord_fixed() +
  Mytheme(size_labs = 8)
ggsave(filename = paste0(path,"/figures/ATvsCT1p.png"), plot = ATvsCT1p)
...
cowplot::ggsave(file=paste0(path,"/figures/fig_paper_interannual_1m.png"), g, width=15, height = 17, units = "cm")
cowplot::ggsave(file=paste0(path,"/figures/fig2.pdf"), g, width = 18, height = 21, units = "cm")
...
fig_poc_pon <- ggplot(data = filter(pom_l, depth==1), aes(x = date, y = value), na.rm=TRUE) + 
  ...
  Mytheme()
ggsave(file= paste0(path,"/figures/fig_poc_pon.png"), fig_poc_pon, width = 18, height = 20, units = "cm")
```
...
![interannual_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_paper_interannual_1m.png)
![poc_pon](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_poc_pon.png)
![ta_vs_salinity_month_pointB_0m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_ta_vs_salinity_month_pointB_0m.png)
...
ATvsCT50p <- ggplot(mean50m, aes(x = sampling_date, y = mean_ta/mean_dic), na.rm=TRUE) +
  ...
  coord_fixed() +
  Mytheme(size_labs = 8)
ggsave(filename = paste0(path,"/figures/ATvsCT50p.png"), plot = ATvsCT50p)
...
cowplot::ggsave(file=paste0(path,"/figures/fig_paper_interannual_50m.png"), g, width=15, height = 17, units = "cm")
cowplot::ggsave(file=paste0(path,"/figures/fig3.pdf"), g, width = 18, height = 21, units = "cm")
```
## Interannual changes at 50 m
![interannual_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_paper_interannual_50m.png)
...
cowplot::ggsave(file=paste0(path,"/figures/fig_paper_at_nocarb.png"), g, width=15, height = 17, units = "cm")
...
ggsave(file=paste0(path,"/figures/fig_temp_month.png"), fig_temp_month, width = 15, height = 10, units = "cm")
fig_at_month <- ggplot(data=mean0m_month, aes(x=year, y=at)) + 
  ...
  theme(legend.position="top") +
  guides(col = guide_legend(ncol = 12, byrow = TRUE))
ggsave(file=paste0(path,"/figures/fig_at_month.png"), fig_at_month, width = 15, height = 10, units = "cm")
fig_pCO2_month <- ggplot(data=mean0m_month, aes(x=year, y=pCO2)) + 
  ...
  theme(legend.position="top") +
  guides(col = guide_legend(ncol = 12, byrow = TRUE))
ggsave(file=paste0(path,"/figures/fig_pCO2_month.png"), fig_pCO2_month, width = 15, height = 10, units = "cm")
fig_ct_month <- ggplot(data=mean0m_month, aes(x=year, y=ct)) + 
  ...
  theme(legend.position="top") +
  guides(col = guide_legend(ncol = 12, byrow = TRUE))
ggsave(file=paste0(path,"/figures/fig_ct_month.png"), fig_ct_month, width = 15, height = 10, units = "cm")
...
ggsave(file=paste0(path,"/figures/fig_paper_monthly_rate_AT_CT.png"), fig_paper_monthly_rate_AT_CT, width = 8, height = 8*2/3, units = "cm")
ggsave(file=paste0(path,"/figures/fig5.pdf"), fig_paper_monthly_rate_AT_CT, width = 16, height= 10, units = "cm")
...
fig_temp_quarter <- ggplot(data=mean0m_quart, aes(x=year, y=Temperature)) + 
  ...
  theme(legend.position="top") +
  guides(col = guide_legend(ncol = 12, byrow = TRUE))
ggsave(file=paste0(path,"/figures/fig_temp_quarter.png"), fig_temp_quarter, width = 15, height = 10, units = "cm")
...
fig_at_quarter <- ggplot(data=mean0m_quart, aes(x=year, y=at)) + 
  ...
  theme(legend.position="top") +
  guides(col = guide_legend(ncol = 12, byrow = TRUE))
ggsave(file=paste0(path,"/figures/fig_at_quarter.png"), fig_at_quarter, width = 15, height = 10, units = "cm")
```
...
![temp_month](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_temp_month.png)
![at_month](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_at_month.png)
![pCO2_month](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_pCO2_month.png)
![temp_quarter](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_temp_quarter.png)
![at_quarter](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_at_quarter.png)
...
ggsave(file=paste0(path,"/figures/fig_paper_monthly_rate_AT_CT_50m.png"), fig_paper_monthly_rate_AT_CT_50m, width = 8, height = 8*2/3, units = "cm")
ggsave(file=paste0(path,"/figures/fig4b.pdf"), fig_paper_monthly_rate_AT_CT_50m, width = 16, height= 10, units = "cm")
```
...
ggsave(file=paste0(path,"/figures/fig_deconv_pH_1m.png"), fig_deconv_pH_1m, width = 18, height = 20, units = "cm")
...
fig_deconv_pH_1m_ano <- ggplot(ano_deconv_pH_1m_melt) + geom_point(aes(x=date, y=value, color=variable), size=0.5) +
  ...
  Mytheme() +
  scale_colour_discrete(guide="none")
ggsave(file=paste0(path,"/figures/fig_deconv_pH_1m_ano.png"), fig_deconv_pH_1m_ano, width = 18, height = 20, units = "cm")
```
...
![garcia-ibanez](../../pCloud Sync/exp153_carbonates_point_B/various/garcia-ibanez.png)
...
![deconv_pH_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deconv_pH_1m.png)
...
![deconv_pH_1m_ano](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deconv_pH_1m_ano.png)
...
ggsave(file=paste0(path,"/figures/fig_dpH_T_y_dT_1m.png"), fig_dpH_T_dT_y_1m, width = 18, height = 12, units = "cm")
...
fig_dT_dt <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dT_dt_1m.png"), fig_dT_dt, width = 18, height = 12, units = "cm")
...
fig_dpH_S_dS_y_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_S_dS_y_1m.png"), fig_dpH_S_dS_y_1m, width = 18, height = 12, units = "cm")
...
fig_dS_dt_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dS_dt_1m.png"), fig_dS_dt_1m, width = 18, height = 12, units = "cm")
...
fig_dpH_AT_dAT_y_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_AT_dT_y_1m.png"), fig_dpH_AT_dAT_y_1m, width = 18, height = 12, units = "cm")
...
fig_dAT_dt_1m <- ggreg(fit) +
  labs(x="Year", y="AT") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dAT_dt_1m.png"), fig_dAT_dt_1m, width = 18, height = 12, units = "cm")
...
fig_dpH_CT_dCT_y_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_CT_y_dT_1m.png"), fig_dpH_CT_dCT_y_1m, width = 18, height = 12, units = "cm")
...
fig_dCT_dt_1m <- ggreg(fit) +
  labs(x="Year", y="CT") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dCT_dt_1m.png"), fig_dCT_dt_1m, width = 18, height = 12, units = "cm")
...
![dpH_CT_dCT_y_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_T_y_dT_1m.png)
![dT_dt_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dT_dt_1m.png)
![dpH_S_dS_y_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_S_dS_y_1m.png)
![dS_dt_1m.](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dS_dt_1m.png)
![dpH_AT_dT_y_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_AT_dT_y_1m.png)

![dAT_dt_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dAT_dt_1m.png)




![fig_dpH_CT_y_dT_1m.png](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_CT_y_dT_1m.png)
![dCT_dt_1m](../../pCloud Sync/exp153_carbonates_point_B//figures/fig_dCT_dt_1m.png)
...
fig_dpH_T_dT_ym_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_T_ym_dT_1m.png"), fig_dpH_T_dT_ym_1m, width = 18, height = 12, units = "cm")
...
fig_dT_dt_1m <- ggreg(fit) +
  labs(x="Year", y="Temperature") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dT_dt_1m.png"), fig_dT_dt_1m, width = 18, height = 12, units = "cm")
...
fig_dpH_S_dS_ym_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_S_dS_ym_1m.png"), fig_dpH_S_dS_ym_1m, width = 18, height = 12, units = "cm")
...
fig_dpH_AT_dAT_ym_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_AT_dT_ym_1m.png"), fig_dpH_AT_dAT_ym_1m, width = 18, height = 12, units = "cm")
...
fig_dpH_CT_dCT_ym_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_CT_ym_dT_1m.png"), fig_dpH_CT_dCT_ym_1m, width = 18, height = 12, units = "cm")
...
![dpH_T_dT_ym_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_T_ym_dT_1m.png)
![dT_dt_1m](../../pCloud Sync/exp153_carbonates_point_B//figures/fig_dT_dt_1m.png)
![dpH_S_dS_ym_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_S_dS_ym_1m.png)
![dS_dt_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dS_dt_1m.png)
![fig_dpH_AT_dT_ym_1m.png](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_AT_dT_ym_1m.png)
![fig_dAT_dt_1m.png](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dAT_dt_1m.png)
![dpH_CT_ym_dT_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_CT_ym_dT_1m.png)
![dCT_dt_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dCT_dt_1m.png)
...
fig_dpH_T_dT_t_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_T_t_dT_1m.png"), fig_dpH_T_dT_t_1m, width = 18, height = 12, units = "cm")
...
fig_dpH_S_dS_t_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_S_dS_t_1m.png"), fig_dpH_S_dS_t_1m, width = 18, height = 12, units = "cm")
...
fig_dpH_AT_dAT_t_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_AT_dT_t_1m.png"), fig_dpH_AT_dAT_t_1m, width = 18, height = 12, units = "cm")
...
fig_dpH_CT_dCT_t_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_CT_t_dT_1m.png"), fig_dpH_CT_dCT_t_1m, width = 18, height = 12, units = "cm")
...
![dpH_T_t_dT_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_T_t_dT_1m.png)
![dT_dt_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dT_dt_1m.png)
![dpH_S_dS_t_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_S_dS_t_1m.png)
![dS_dt_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dS_dt_1m.png)
![dpH_AT_dT_t_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_AT_dT_t_1m.png)
![dAT_dt_1m.png](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dAT_dt_1m.png)
![dpH_CT_t_dT_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_CT_t_dT_1m.png)
![dCT_dt_1m.](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dCT_dt_1m.png)
...
fig_deconv_pCO2_1m <- ggplot(deconv_pCO2_1m_melt) + geom_point(aes(x=date, y=value, color=variable), size=0.5) +
  ...
  Mytheme() +
  scale_colour_discrete(guide="none")
ggsave(file=paste0(path,"/figures/fig_deconv_pCO2_1m.png"), fig_deconv_pCO2_1m, width = 18, height = 20, units = "cm")
...
fig_deconv_pCO2_1m_ano <- ggplot(ano_deconv_pCO2_1m_melt) + geom_point(aes(x=date, y=value, color=variable), size=0.5) +
  ...
  Mytheme() +
  scale_colour_discrete(guide="none")
ggsave(file=paste0(path,"/figures/fig_deconv_pCO2_1m_ano.png"), fig_deconv_pCO2_1m_ano, width = 18, height = 20, units = "cm")
```
Below is the deconvolution performed on values. Here, dvar is the monthly mean value of T, S and CT for the entire time-series.

![deconv_pCO2_1m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deconv_pCO2_1m.png)
Below is the deconvolution performed on anomalies Here, dvar is the monthly mean value of the anomalies of T, S and CT for the entire time-series.

![deconv_pCO2_1m_ano](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deconv_pCO2_1m_ano.png)
...
fig_dpCO2_T_dT_t_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpCO2_T_t_dT_1m.png"), fig_dpCO2_T_dT_t_1m, width = 18, height = 12, units = "cm")
...
fig_dpCO2_S_dS_t_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpCO2_S_dS_t_1m.png"), fig_dpCO2_S_dS_t_1m, width = 18, height = 12, units = "cm")
...
fig_dpCO2_AT_dAT_t_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpCO2_AT_dT_t_1m.png"), fig_dpCO2_AT_dAT_t_1m, width = 18, height = 12, units = "cm")
...
fig_dpCO2_CT_dCT_t_1m <- ggreg(fit) +
  ...
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpCO2_CT_t_dT_1m.png"), fig_dpCO2_CT_dCT_t_1m, width = 18, height = 12, units = "cm")
...
fig_deconv_pH_50m <- ggplot(deconv_pH_50m_melt) + geom_point(aes(x=date, y=value, color=variable), size=0.5) +
  ...
  Mytheme() +
  scale_colour_discrete(guide="none")
ggsave(file=paste0(path,"/figures/fig_deconv_pH_50m.png"), fig_deconv_pH_50m, width = 18, height = 20, units = "cm")
...
fig_deconv_pH_ano_50m <- ggplot(ano_deconv_pH_50m_melt) + geom_point(aes(x=date, y=value, color=variable), size=0.5) +
  ...
  Mytheme() +
  scale_colour_discrete(guide="none")
ggsave(file=paste0(path,"/figures/fig_deconv_pH_ano_50m.png"), fig_deconv_pH_ano_50m, width = 18, height = 20, units = "cm")
```
...
![deconv_pH_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deconv_pH_50m.png)
...
![deconv_pH_ano_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deconv_pH_ano_50m.png)
...
fig_deconv_pCO2_50m <- ggplot(deconv_pCO2_50m_melt) + geom_point(aes(x=date, y=value, color=variable), size=0.5) +
  ...
  Mytheme() +
  scale_colour_discrete(guide="none")
ggsave(file=paste0(path,"/figures/fig_deconv_pCO2_50m.png"), fig_deconv_pCO2_50m, width = 18, height = 20, units = "cm")
...
fig_deconv_pCO2_50m_ano <- ggplot(ano_deconv_pCO2_50m_melt) + geom_point(aes(x=date, y=value, color=variable), size=0.5) +
  ...
  Mytheme() +
  scale_colour_discrete(guide="none")
ggsave(file=paste0(path,"/figures/fig_deconv_pCO2_50m_ano.png"), fig_deconv_pCO2_50m_ano, width = 18, height = 20, units = "cm")
```
Below is the deconvolution performed on values. Here, dvar is the monthly mean value of T, S and CT for the entire time-series.

![deconv_pCO2_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deconv_pCO2_50m.png)
Below is the deconvolution performed on anomalies Here, dvar is the monthly mean value of the anomalies of T, S and CT for the entire time-series.

![deconv_pCO2_50m_ano](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deconv_pCO2_50m_ano.png)
...
fig_dpH_T_dT_t_50m <- ggreg(fit) +
  labs(x="Temperature (total mean)", y="pH") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_T_t_dT_50m.png"), fig_dpH_T_dT_t_50m, width = 18, height = 12, units = "cm")

fit <- lm(data = deconv_garcia_dat_pH_50m, T ~ sampling_date)
fig_dT_dt_50m <- ggreg(fit) +
  labs(x="Year", y="Temperature") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dT_dt_50m.png"), fig_dT_dt_50m, width = 18, height = 12, units = "cm")
...
fig_dpH_S_dS_t_50m <- ggreg(fit) +
  labs(x="Salinity (total mean)", y="pH") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_S_dS_t_50m.png"), fig_dpH_S_dS_t_50m, width = 18, height = 12, units = "cm")

fit <- lm(data = deconv_garcia_dat_pH_50m, S ~ sampling_date)
fig_dS_dt_50m <- ggreg(fit) +
  labs(x="Year", y="Salinity") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dS_dt_50m.png"), fig_dS_dt_50m, width = 18, height = 12, units = "cm")
...
fig_dpH_AT_dAT_t_50m <- ggreg(fit) +
  labs(x="AT (total mean)", y="pH") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_AT_dT_t_50m.png"), fig_dpH_AT_dAT_t_50m, width = 18, height = 12, units = "cm")
...
fig_dAT_dt_50m <- ggreg(fit) +
  labs(x="Year", y="AT") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dAT_dt_50m.png"), fig_dAT_dt_50m, width = 18, height = 12, units = "cm")
...
fig_dpH_CT_dCT_t_50m <- ggreg(fit) +
  labs(x="CT (total mean)", y="pH") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpH_CT_t_dT_50m.png"), fig_dpH_CT_dCT_t_50m, width = 18, height = 12, units = "cm")
...
fig_dCT_dt_50m <- ggreg(fit) +
  labs(x="Year", y="CT") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dCT_dt_50m.png"), fig_dCT_dt_50m, width = 18, height = 12, units = "cm")
...
![dpH_T_t_dT_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_T_t_dT_50m.png)
![dT_dt_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dT_dt_50m.png)
![dpH_S_dS_t_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_S_dS_t_50m.png)
![dS_dt_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dS_dt_50m.png)
![dpH_AT_dT_t_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_AT_dT_t_50m.png)
![dAT_dt_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dAT_dt_50m.png)
![dpH_CT_t_dT_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dpH_CT_t_dT_50m.png)
![dCT_dt_50m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_dCT_dt_50m.png)
...
fig_dpCO2_T_dT_t_50m <- ggreg(fit) +
  labs(x="Temperature (total mean)", y="pCO2") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpCO2_T_t_dT_50m.png"), fig_dpCO2_T_dT_t_50m, width = 18, height = 12, units = "cm")
...
fig_dpCO2_S_dS_t_50m <- ggreg(fit) +
  labs(x="Salinity (total mean)", y="pCO2") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpCO2_S_dS_t_50m.png"), fig_dpCO2_S_dS_t_50m, width = 18, height = 12, units = "cm")
...
fig_dpCO2_AT_dAT_t_50m <- ggreg(fit) +
  labs(x="AT (total mean)", y="pCO2") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpCO2_AT_dT_t_50m.png"), fig_dpCO2_AT_dAT_t_50m, width = 18, height = 12, units = "cm")
...
fig_dpCO2_CT_dCT_t_50m <- ggreg(fit) +
  labs(x="CT (total mean)", y="pCO2") +
  Mytheme(size_labs = 10)
ggsave(file=paste0(path,"/figures/fig_dpCO2_CT_t_dT_50m.png"), fig_dpCO2_CT_dCT_t_50m, width = 18, height = 12, units = "cm")
...
p1 <- ggplot(data=dplyr::filter(means_depth, depth== 0)) +
  ...
  Mytheme()
png(file = paste0(path,"/figures/fig_ta_vs_salinity_month_pointB_0m.png"), 
...
Mytheme_facet()
ggsave(p1, file = paste0(path,"/figures/fig_ta_vs_salinity_year_pointB_0m.png"), 
    width = 6, height = 6)

# AT versus salinity at the surface per year with loop
panel <- c("(a)","(b)","(c)","(d)","(e)","(f)","(g)","(h)","(i)", "(j)", "(k)")
...
g1 <- plot_grid(p[[1]], p[[2]], p[[3]], p[[4]], p[[5]], p[[6]], p[[7]], p[[8]], p[[9]], p[[10]], ncol=3, align="vh")
...
cowplot::ggsave(file=paste0(path,"/figures/fig6.pdf"), g, width = 16, height = 15, units = "cm")
...
p1 <- ggplot(data=mean0m) +
  ...
  Mytheme()
ggsave(p1, filename = paste0(path,"/figures/fig_ta_vs_salinity_all_pointB_0m.png"), width = 20, height = 13, units = "cm")
...
p1 <- ggplot(data=means_month0m) +
  ...
  Mytheme()
png(file = paste0(path,"/figures/fig_ta_vs_salinity_monthly_means_pointB_0m.png"), 
    width = 20, height = 13, units = "cm", res = 300)
print(p1)
dev.off()
...
ggsave(paste0(path,"/figures/precip.png"),g, width = 18, height = 14, units = "cm")
cowplot::ggsave(paste0(path,"/figures/figS2.pdf"),g, width = 8, height = 14, units = "cm")
```

The relationship between AT and salinity using all data is shown below.
![ta_vs_salinity_all_pointB_0m](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_ta_vs_salinity_all_pointB_0m.png)

The relationship between AT and salinity using monthly means is shown below.
![ta_vs_salinity_monthly_means_pointB_0m.](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_ta_vs_salinity_monthly_means_pointB_0m.png)
...
![precip](../../pCloud Sync/exp153_carbonates_point_B/figures/precip.png)


## Daily and monthly changes in pH and T
```{r Daily and seasonal changes, include=FALSE}
# Long series
continuous_discrete <- read_csv(file = paste0(path,"/data/continuous_discrete.csv"), col_names = TRUE)
...
plot_range_pH_Chla_month <-  ggplot(data = range_month) +
  ...
  theme_bw()
ggsave(paste0(path,"/figures/plot_range_pH_Chla_month.png"), plot_range_pH_Chla_month)
...
plot_range_pH_Temperature <-  ggplot(data = range_month) +
  ...
  annotation_custom(grob_A)
ggsave(paste0(path,"/figures/plot_range_pH_Temperature.png"), plot_range_pH_Temperature)
...
ggsave(paste0(path,"/figures/fig_paper_time_series.png"), g, width = 18, height = 14, units = "cm")
cowplot::ggsave(file=paste0(path,"/figures/fig7.pdf"), g, width = 8, height = 16, units = "cm")
...
plot_range_pH_Chla_week <-  ggplot(data =  range_year_week) +
  ...
  theme(aspect.ratio=1/2,
        axis.title.x = element_text(margin=margin(t=0.25, r=0, b=0.25, l=0, unit = "cm"))) +
  annotation_custom(grob_B)
ggsave(paste0(path,"/figures/plot_range_pH_Chla_week.png"), plot_range_pH_Chla_week)

plot_range_pH_Chla_temp <- plot_grid(plot_range_pH_Temperature,
                                     plot_range_pH_Chla_week, ncol = 1, align = "h")
ggsave(paste0(path,"/figures/plot_range_pH_Chla_temp.png"), plot_range_pH_Chla_temp, width = 8)
cowplot::ggsave(paste0(path,"/figures/figS1.pdf"), plot_range_pH_Chla_temp, width = 8, height = 8)

```

The average error in pH due to spatiotemporal mismatch between sensor and discrete sample is `r average_offset`.
![time_series](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_paper_time_series.png)
...
![_range_pH_Chla_month](../../pCloud Sync/exp153_carbonates_point_B/figures/plot_range_pH_Chla_month.png)
![range_pH_Chla_temp](../../pCloud Sync/exp153_carbonates_point_B/figures/plot_range_pH_Chla_temp.png)
...
ggsave(paste0(path,"/figures/fig_atm_CO2.png"), g)
```
...
![atm_CO2](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_atm_CO2.png)
...
deff_monthly <- ggplot() +
  ...
  ggsave(file = paste0(path,"/figures/fig_deffayes_monthly.png"), deff_monthly,
...
![deffayes_monthly](../../pCloud Sync/exp153_carbonates_point_B/figures/fig_deffayes_monthly.png)
