...
![figures/dyf_surf_salinity_AT_year.png](../figures/dyf_surf_salinity_AT_year.png)
...
![fig_paper_monthly_means_1m.png](../figures/fig_paper_monthly_means_1m.png)
...
cowplot::ggsave(file="../figures/fig2.pdf", g, width = 18, height = 21, units = "cm")
...
![fig_paper_interannual_1m.png](`r paste0(path,"/figures/fig_paper_interannual_1m.png`)
![fig_poc_pon.png](../figures/fig_poc_pon.png)
![fig_ta_vs_salinity_month_pointB_0m.png](../figures/fig_ta_vs_salinity_month_pointB_0m.png)
...
![fig_paper_interannual_50m.png](../figures/fig_paper_interannual_50m.png)
...
![fig_temp_month.png](../figures/fig_temp_month.png)
![fig_at_month.png](../figures/fig_at_month.png)
![fig_pCO2_month.png](../figures/fig_pCO2_month.png)
![fig_temp_quarter.png](../figures/fig_temp_quarter.png)
![fig_at_quarter.png](../figures/fig_at_quarter.png)
...
![fig_deconv_pH_1m.png](../figures/fig_deconv_pH_1m.png)
...
![fig_deconv_pH_1m_ano.png](../figures/fig_deconv_pH_1m_ano.png)
...
![fig_dpH_CT_dCT_y_1m.png](../figures/fig_dpH_T_y_dT_1m.png)
![fig_dT_dt_1m.png](../figures/fig_dT_dt_1m.png)
![fig_dpH_S_dS_y_1m.png](../figures/fig_dpH_S_dS_y_1m.png)
![fig_dS_dt_1m.png](../figures/fig_dS_dt_1m.png)
![fig_dpH_AT_dT_y_1m.png](../figures/fig_dpH_AT_dT_y_1m.png)
...
![fig_dCT_dt_1m.png](../figures/fig_dCT_dt_1m.png)
...
![fig_dpH_T_dT_ym_1m.png](../figures/fig_dpH_T_ym_dT_1m.png)
![fig_dT_dt_1m.png](../figures/fig_dT_dt_1m.png)
![fig_dpH_S_dS_ym_1m.png](../figures/fig_dpH_S_dS_ym_1m.png)
![fig_dS_dt_1m.png](../figures/fig_dS_dt_1m.png)
![fig_dpH_AT_dT_ym_1m.png](../figures/fig_dpH_AT_dT_ym_1m.png)
![fig_dAT_dt_1m.png](../figures/fig_dAT_dt_1m.png)
![fig_dpH_CT_ym_dT_1m.png](../figures/fig_dpH_CT_ym_dT_1m.png)
![fig_dCT_dt_1m.png](../figures/fig_dCT_dt_1m.png)
...
![fig_dpH_T_t_dT_1m.png](../figures/fig_dpH_T_t_dT_1m.png)
![fig_dT_dt_1m.png](../figures/fig_dT_dt_1m.png)
![fig_dpH_S_dS_t_1m.png](../figures/fig_dpH_S_dS_t_1m.png)
![fig_dS_dt_1m.png](../figures/fig_dS_dt_1m.png)
![fig_dpH_AT_dT_t_1m.png](../figures/fig_dpH_AT_dT_t_1m.png)
![fig_dAT_dt_1m.png](../figures/fig_dAT_dt_1m.png)
![fig_dpH_CT_t_dT_1m.png](../figures/fig_dpH_CT_t_dT_1m.png)
![fig_dCT_dt_1m.png](../figures/fig_dCT_dt_1m.png)
...
![fig_deconv_pCO2_1m.png](../figures/fig_deconv_pCO2_1m.png)
Below is the deconvolution performed on anomalies Here, dvar is the monthly mean value of the anomalies of T, S and CT for the entire time-series.

![fig_deconv_pCO2_1m_ano.png](../figures/fig_deconv_pCO2_1m_ano.png)
...
![fig_deconv_pH_50m.png](../figures/fig_deconv_pH_50m.png)
...
![fig_deconv_pH_ano_50m.png](../figures/fig_deconv_pH_ano_50m.png)
...
![fig_deconv_pCO2_50m.png](../figures/fig_deconv_pCO2_50m.png)
Below is the deconvolution performed on anomalies Here, dvar is the monthly mean value of the anomalies of T, S and CT for the entire time-series.

![fig_deconv_pCO2_50m_ano.png](../figures/fig_deconv_pCO2_50m_ano.png)
...
![fig_dpH_T_t_dT_50m.png](../figures/fig_dpH_T_t_dT_50m.png)
![fig_dT_dt_50m.png](../figures/fig_dT_dt_50m.png)
![fig_dpH_S_dS_t_50m.png](../figures/fig_dpH_S_dS_t_50m.png)
![fig_dS_dt_50m.png](../figures/fig_dS_dt_50m.png)
![fig_dpH_AT_dT_t_50m.png](../figures/fig_dpH_AT_dT_t_50m.png)
![fig_dAT_dt_50m.png](../figures/fig_dAT_dt_50m.png)
![fig_dpH_CT_t_dT_50m.png](../figures/fig_dpH_CT_t_dT_50m.png)
![fig_dCT_dt_50m.png](../figures/fig_dCT_dt_50m.png)
...
cowplot::ggsave(file="../figures/fig6.pdf", g, width = 16, height = 15, units = "cm")
...
![fig_ta_vs_salinity_all_pointB_0m.png](../figures/fig_ta_vs_salinity_all_pointB_0m.png)

The relationship between AT and salinity using monthly means is shown below.
![fig_ta_vs_salinity_monthly_means_pointB_0m.png](../figures/fig_ta_vs_salinity_monthly_means_pointB_0m.png)
...
cowplot::ggsave(file="../figures/fig7.pdf", g, width = 8, height = 16, units = "cm")
...
![fig_paper_time_series.png](../figures/fig_paper_time_series.png)
...
![plot_range_pH_Chla_month.png](../figures/plot_range_pH_Chla_month.png)
![plot_range_pH_Chla_temp.png](../figures/plot_range_pH_Chla_temp.png)
...
![fig_atm_CO2.png](../figures/fig_atm_CO2.png)
...
![fig_deffayes_monthly.png](../figures/fig_deffayes_monthly.png)
