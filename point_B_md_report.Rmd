...
#getwd()
dyf <- tbl_df(read.table(paste0("../data/", "carb_dyfamed.txt"), 
...
png(file = "../figures/fig_dyf_date_AT.png", 
...
png(file = "../figures/fig_dyf_AT_salinity.png", 
    width = 15, height = 10, units = "cm", res = 300)
...
fig_dyf_surf_date_AT <- ggplot(data = dyf_surf, aes(x=date, y=AT)) +
  ...
  stat_smooth(method = lm, na.rm=TRUE)
png(file = "../figures/fig_dyf_surf_date_AT.png", 
    width = 15, height = 10, units = "cm", res = 300)
...
dyf_surf_salinity_AT <- ggplot(data = dyf_surf, aes(x=salinity, y=AT), na.rm=TRUE) +
  ...
  stat_smooth(method = lm, na.rm=TRUE)
ggsave(file = "../figures/dyf_surf_salinity_AT.png", dyf_surf_salinity_AT,
...
png(file = "../figures/fig_outliers.png",
...
cowplot::ggsave(file="../figures/fig_paper_interannual_1m.png", g, width=15, height = 17, units = "cm")
...
cowplot::ggsave(file="../figures/fig_paper_interannual_50m.png", g, width=15, height = 17, units = "cm")
cowplot::ggsave(file="../figures/fig3.pdf", g, width = 18, height = 21, units = "cm")
```
...
cowplot::ggsave(file="../figures/fig_paper_at_nocarb.png", g, width=15, height = 17, units = "cm")
...
cowplot::ggsave("../figures/figS2.pdf",g, width = 8, height = 14, units = "cm")
```
...
cowplot::ggsave("../figures/figS1.pdf", plot_range_pH_Chla_temp, width = 8, height = 8)
