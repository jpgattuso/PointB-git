...
#make the mean with same date en rounded time + filter only surface data 0 to 3 m.
means_eol <- eol %>%
...
## EOL - point B comparaison

### Temperature
```{r eol pointb comp, echo=FALSE, warning = FALSE, message = FALSE, out.width='70%'}
