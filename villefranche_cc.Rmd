...
if (Sys.getenv("LOGNAME") == "gattuso") {
  ...
  path_sami = "../../pCloud\ Sync/Documents/experiments/exp176_sami/sami_data/sami_processed/Data_deployment/PointB/"
}
if (Sys.getenv("LOGNAME") == "samir") {
  path = "../../pCloud Sync/exp153_carbonates_point_B/"
  path_sami = "../../pCloud\ Sync/exp176_sami/sami_data/sami_processed/Data_deployment/PointB/"
}
