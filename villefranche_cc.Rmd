...
kable(broom::tidy(reg_Temperature), digits = c(5,5,5,3,3), caption="Regressions on values monthly means of pH range as a function of temperature")
kable(broom::tidy(reg_Chla), digits = c(5,5,5,3,3), caption="Regressions on values monthly means of pH range as a function of Chla")
```
