...
if (Sys.getenv("LOGNAME") == "samir") {
  ...
  path_par ="../../pCloud Sync/Light_Series_Odyssey/Villefranche/"
}
...
eol_ptb_temp_xts <- dplyr::select(eol_ptb_5m, datetime, mean_temp_rhB, temp_eol)
eol_ptb_temp_xts <- as.xts(eol_ptb_temp_xts, order.by=eol_ptb_5m$datetime)
...
fit <- lmodel2(data = eol_ptb_5m, mean_temp_rhB ~ temp_eol, nperm = 99)
