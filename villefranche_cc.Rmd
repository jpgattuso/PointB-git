...
d <- dplyr::mutate(d, datetime=str_c(Date, " ", Heure) %>% parse_datetime(format="%Y%m%d %H%M%S"))
ggplot(d) + geom_point((aes(x=datetime, y=T)))
saveRDS(d, file = paste0(path, "data/eol/eol_data.rds"))
