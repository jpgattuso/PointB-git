...
Temperature (in blue, °C), salinity (in purple, PSU) and oxygen (in green, ml/l) data from the EOL ctd. We also compare salinity and temperature with the SOMLIT data.
