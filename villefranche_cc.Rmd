...
>By all accounts, this instrument appears to be functioning correctly.  The blank signals are stable, indicating no air bubbles in the lines. Absorbances show a good curve in the expected range, indicating that the pump and valve are working properly.

>I want to be clear on some of the procedures though.
...
>I have attached seawater and Tris tests on this unit before we shipped it.

>I think this instrument is working fine, and you should try deploying it.  Also, go back into your data and make sure you are handling temperature correctly to see if that improves accuracy.
