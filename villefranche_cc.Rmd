...
dySeries("diff_pH", drawPoints = TRUE, pointSize=3, label = "pH INT", color="green")%>%
    dyLimit(0,strokePattern = "dashed", color = "black") %>% 
  dyAxis("y",valueRange = c(-0.004, 0.004))%>%
  dyAxis("x",valueRange = c("2021-09-28 04:00:00", "2021-10-19 12:00:00"
))%>%
dyOptions(
    drawGrid = TRUE,
    strokeWidth= 0,
