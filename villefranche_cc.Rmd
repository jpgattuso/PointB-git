...
par_periode <- c("2020-10-29 12:20:00", "2020-12-09 08:00:00","2020-12-17 10:00:00","2021-03-16 11:00:00","2021-03-17 11:00:00", "2021-05-21 06:50:00","2021-06-11 10:00:00", "2021-11-26 09:00:00", "2021-12-03 11:00:00", "2022-03-23 08:50:00")
...
par_periode_air <- c("2020-12-17 10:00:00","2021-03-16 09:00:00","2021-03-17 13:00:00","2021-06-11 07:30:00", "2021-06-11 09:00:00","2021-11-26 09:00:00","2021-12-03 11:00:00", "2022-03-23 08:50:00")
####### AIR
...
winkler_surface<- tbl_df(
  read_delim(file=paste0(path,"/data/Somlit/Somlit_Extraction_hydro_surface_1997-2021.csv"),
delim = ";", 
skip= 4,
...
#Winkler FOND
winkler_fond<- tbl_df(
  read_delim(file=paste0(path,"/data/Somlit/Somlit_Extraction_hydro_fond_1997-2021.csv"), 
delim = ";", 
skip= 4,
col_names = FALSE,# col_types = typ,
na = c("NA", "999999")) )#%>%
  ...
  dplyr::mutate(correction_sal = case_when(datetime >"2014-05-06 00:00:00" & datetime <"2014-10-07 23:59:00" ~ slope_p1 * unclass(datetime) + intercept_p1, 
                ...
                slope_sal = case_when(datetime >"2014-05-06 00:00:00" & datetime <"2014-10-07 23:59:00" ~ slope_p1 , 
                 ...
                 periode_sal = case_when(datetime >"2014-05-06 00:00:00" & datetime <"2014-10-07 23:59:00" ~ "p1" , 
                                       ...
                                       datetime >"2014-10-14 00:00:00" & datetime <"2015-06-16 23:59:00" ~ "p2" ,TRUE ~ NA_character_),
