...
###
ptb_wink_ctd_xts <- dplyr::select(rh_B_Bplus_1m_mean, date, mean_oxy_mll_rhBplus,mean_oxy_mll_rhB)
...
dySeries("mean_oxy_mll_rhB", drawPoints = TRUE, pointSize=3, label = "Oxy winkler PTB", color ="green")%>%
 # dyLegend(show = "always", width = 600)%>%
  #dyAxis("y",valueRange = c(-0.1, 0.11))%>%
dyOptions(
    drawGrid = TRUE,
