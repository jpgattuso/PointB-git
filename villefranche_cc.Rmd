...
par_air$datetime <- dmy_hms(par_air$date)
```
...
par_all <- left_join(par_all,par_air,by="datetime")
# remove outliers due to end of periode (raising to the surface + lab manipulations)
# add each periode of time to be removed
par_all <- par_all %>% 
  dplyr::filter(datetime < as.POSIXct("2021-03-16 10:00:00") | datetime > as.POSIXct("2021-03-16 14:00:00") &
                datetime < as.POSIXct("2021-05-25 08:00:00") | datetime > as.POSIXct("2021-06-11 12:00:00") )
# add each periode here
par_periode <- c("2020-10-29 14:20:00", "2020-12-09 09:00:00","2020-12-17 11:00:00","2021-03-16 13:00:00", "2021-05-25 08:00:00")
...
## Events
sami_events <- c("2019-12-16 11:00:00", "2020-02-25 16:00:00","2020-06-17 08:00:00","2020-06-19 10:00:00","2020-07-15 10:00:00","2020-07-17 18:00:00", "2020-08-10 00:00:00", "2020-12-10 13:00:00","2020-12-17 09:00:00","2021-02-17 09:00:00","2021-03-17 12:00:00","2021-03-30 09:30:00","2021-04-21 08:30:00","2021-04-22 10:00:00")
