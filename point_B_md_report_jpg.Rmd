...
vlfrcc <- dat %>% 
  dplyr::select(sampling_date, depth, salinity, temperature, dic, ta, pH_calc, pH_insi, Pt, Sit)
vlfrcc <- left_join(vlfrcc, eol_ptb %>% dplyr::select(sampling_date, depth, pH_s_eol_temp_insi, pH_s_ptb_temp_insi), by=c("sampling_date", "depth"))
